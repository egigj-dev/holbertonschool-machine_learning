...
def inception_network():
    ...
    # Stage 1: Conv 7x7/2
    C1 = K.layers.Conv2D(64, (7, 7), strides=(2, 2), padding='same')(X)
    C1 = K.layers.ReLU()(C1)
    ...
    C2 = K.layers.Conv2D(64, (1, 1), strides=(1, 1), padding='same')(P1)
    C2 = K.layers.ReLU()(C2)

    # Stage 2: Conv 3x3/1
    C3 = K.layers.Conv2D(192, (3, 3), strides=(1, 1), padding='same')(C2)
    C3 = K.layers.ReLU()(C3)
